...
//    @Inject
//    lateinit var launchesCall: Call
//

    private val checkString = ""
...
//        saveDateToSharedPreference(app, dateMillis)
    ...
    fun observeDataIdDB(myApp: MyApplication): LiveData<List<Launch>> {
        return myApp.database.getDao().getLaunches()
    }
